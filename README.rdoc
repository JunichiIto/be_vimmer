...
Tweets are pushed via cron task on server.(See +lib/tasks/cron.rb+ ) You need to register Twitter credentials on Pit (http://rubygems.org/gems/pit) configurations or environment variables before execution.
...
The following command means "Post 3 tweets every 2 hours in Japanese." 
